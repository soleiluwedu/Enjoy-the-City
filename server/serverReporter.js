...
// reqLog object contains functions that stringifies parts of the request object.
const reqLog = {
...
// actions object contains functions that deliver final actions.
const actions = {
...
const serverReporter = {
  ...
  response: (req, res, next) => {
    ...
    if (res.locals.err) actions.print(`❗ ${stylized.error(res.locals.err.message)}`);

    // If no error, assume successful delivery of payload.
    else {
